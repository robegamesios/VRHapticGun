            ...
            if (splitted.Length > 0)
            {
                ...
                else if (command == "PlayerShootWeapon")
                {
                    if (splitted.Length > 1)
                    {
                        ...
                        String weapon = splitted[1].Trim();
                        if (weapon == "hlvr_weapon_energygun")
                        {
                            createHapticFeedbackRight("1");

                        } 
                        else if (weapon == "hlvr_weapon_rapidfire")
                        {
                            createHapticFeedbackRight("22");
                        }
                        else if (weapon == "hlvr_weapon_shotgun")
                        {
                            createHapticFeedbackRight("333");
                ...
                else if (command == "PlayerGrabbityLockStart")
                {
                    if (splitted.Length > 1)
                    {
                        ...
                        if (primary == 1)
                        {
                            createHapticFeedbackRight("55555");
                        } 
                        else
                        {
                            createHapticFeedbackLeft("55555");
                        }
                    }
                }
                ...
                else if (command == "PlayerHeal")
                {
                    ...
                    if (primary == 1)
                    {
                        createHapticFeedbackRight("4444");
                    }
                    else
                    {
                        createHapticFeedbackLeft("4444");
                    }
                }
...
//            }
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            if (tactsuitVr != null)
            {
                ...
                else if (testBtnCount == 2)
                {
                    createHapticFeedbackRight("22");
                    testBtnCount++;
                }
                else if (testBtnCount == 3)
                {
                    createHapticFeedbackRight("333");
                    testBtnCount++;
                }
                else if (testBtnCount == 4)
                {
                    createHapticFeedbackRight("4444");
                    testBtnCount =1;
                }
